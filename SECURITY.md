...
a remote execution exploit -- please [**report privately**](https://github.com/thusharprakash/go-libp2p/security/advisories/new).
...
For non-security bugs, please simply file a GitHub [issue](https://github.com/thusharprakash/go-libp2p/issues/new).
