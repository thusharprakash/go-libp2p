...
//go:generate go run go.uber.org/mock/mockgen -package transport_integration -destination mock_connection_gater_test.go github.com/thusharprakash/go-libp2p/core/connmgr ConnectionGater
