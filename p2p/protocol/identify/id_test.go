...
import (
	...
	coretest "github.com/thusharprakash/go-libp2p/core/test"
	basichost "github.com/thusharprakash/go-libp2p/p2p/host/basic"
	blhost "github.com/thusharprakash/go-libp2p/p2p/host/blank"
	...
	"github.com/thusharprakash/go-libp2p/p2p/protocol/identify/pb"
...
func TestNotListening(t *testing.T) {
	...
	//
	// https://github.com/thusharprakash/go-libp2p/issues/939
	ctx, cancel := context.WithCancel(context.Background())
	defer cancel()
