...
// Source: github.com/thusharprakash/go-libp2p/core/network (interfaces: PeerScope)
//
// Generated by this command:
//
//	mockgen -package mocknetwork -destination mock_peer_scope.go github.com/thusharprakash/go-libp2p/core/network PeerScope
//
